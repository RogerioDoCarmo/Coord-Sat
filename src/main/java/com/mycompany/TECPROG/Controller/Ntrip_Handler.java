...
//import com.mycompany.NTRIP.BufferAux;
import com.mycompany.NTRIP.Constantes;
import com.mycompany.NTRIP.Defines;
import com.mycompany.NTRIP.Mathm;
import com.mycompany.NTRIP.RTCM3ParserData;
import com.mycompany.NTRIP.Tempo;
import com.mycompany.NTRIP.converttime;
//import com.mycompany.NTRIP.glonassephemeris;
//import com.mycompany.NTRIP.gpsephemeris;
...
//		controle=1; tam=0; posi=0;
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    private static final void SKIPBITS(int b) {
        loadBITS(b);
        numbits -= (b);
    }
    ...
    private static final void loadBITS(int a) {
        ...
        while (a > numbits) {   // System.out.println("dado[m]:"+dado[m]);
